      ...
      {isMenuOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <Link href="/services" className="block text-gray-700 hover:text-gray-900 px-3 py-2">
              Servizi Veterinari
            </Link>
            <Link href="/about" className="block text-gray-700 hover:text-gray-900 px-3 py-2">
              Chi Siamo
            </Link>
            <Link href="/contact" className="block text-gray-700 hover:text-gray-900 px-3 py-2">
              Contattaci
            </Link>
